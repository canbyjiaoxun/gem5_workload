...
sha_stream ()
{
  ...
  /* randomly set the input data, Xun 08/22/17*/
  // set rand seed 
  int rand_seed; 
  ...
  // generate random input data; Xun 08/22/17 
  //int VSIZE = rand() % 10 + 2; 
  int BLOCK_SIZE = rand() % 4000 + 5000;
  //int BLOCK_SIZE = 5000;
  ...
  for (ii = 0; ii < VSIZE; ii++)   
  {
      ...
      {
          indata[ii][jj] = rand() % 50 + 70;  
      }
  }
  //write input SIZE to a file; Xun 08/22/17 
  //FILE *input_size_file = fopen("./data/sha/input_size.txt", "a");
